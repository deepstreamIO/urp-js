...
export const META_PARAMS_SPEC: { [topic: number]: { [action: number]: [Array<M>, Array<M>] } } = {
  ...
  [TOPIC.RECORD]: {
    ...
    [RA.SUBSCRIBEANDHEAD_BULK]: [[M.names], []],
    [RA.SUBSCRIBEANDHEAD_BULK_ACK]: [[M.correlationId], []],
    [RA.HEAD_RESPONSE]: [[M.name, M.version], []],
    [RA.HEAD_RESPONSE_BULK]: [[M.versions], []],
    [RA.READ]: [[M.name], []],
    [RA.SUBSCRIBEANDREAD]: [[M.name], []],
    [RA.SUBSCRIBEANDREAD_BULK]: [[M.names], []],
    [RA.SUBSCRIBEANDREAD_BULK_ACK]: [[M.correlationId], []],
  ...
  [TOPIC.EVENT]: {
    ...
    [EA.SUBSCRIBE_BULK]: [[M.names, M.correlationId], []],
    [EA.SUBSCRIBE_BULK_ACK]: [[M.correlationId], []],
    [EA.UNSUBSCRIBE]: [[M.name], []],
    [EA.UNSUBSCRIBE_ACK]: [[M.name], []],
    [EA.UNSUBSCRIBE_BULK]: [[M.names, M.correlationId], []],
    [EA.UNSUBSCRIBE_BULK_ACK]: [[M.correlationId], []],
  ...
  [TOPIC.PRESENCE]: {
    [UA.SUBSCRIBE_BULK]: [[M.names, M.correlationId], []],
    [UA.SUBSCRIBE_BULK_ACK]: [[M.correlationId], []],
    [UA.SUBSCRIBE_ALL]: [[], []],
    [UA.SUBSCRIBE_ALL_ACK]: [[], []],
    [UA.UNSUBSCRIBE_BULK]: [[M.names, M.correlationId], []],
    [UA.UNSUBSCRIBE_BULK_ACK]: [[M.correlationId], []],
