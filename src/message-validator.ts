...
export const META_PARAMS_SPEC: { [topic: number]: { [action: number]: [Array<M>, Array<M>] } } = {
  ...
  [TOPIC.RECORD]: {
    [RA.SUBSCRIBE]: [[M.names], []],
    [RA.SUBSCRIBE_ACK]: [[M.correlationId], []],
    [RA.UNSUBSCRIBE]: [[M.names], []],
    [RA.UNSUBSCRIBE_ACK]: [[M.correlationId], []],
    [RA.MULTIPLE_SUBSCRIPTIONS]: [[M.name], [M.originalAction]],
    [RA.NOT_SUBSCRIBED]: [[M.name], []],
    [RA.HEAD]: [[M.name], []],
    [RA.HEAD_BULK]: [[M.names], []],
    [RA.HEAD_RESPONSE]: [[M.name, M.version], []],
    [RA.HEAD_RESPONSE_BULK]: [[M.versions], []],
    [RA.READ]: [[M.name], []],
    [RA.SUBSCRIBEANDHEAD]: [[M.names], []],
    [RA.SUBSCRIBEANDHEAD_ACK]: [[M.correlationId], []],
    [RA.SUBSCRIBEANDREAD]: [[M.names], []],
    [RA.SUBSCRIBEANDREAD_ACK]: [[M.correlationId], []],
    ...
    [RA.DELETED]: [[M.name], []],
    [RA.SUBSCRIBECREATEANDREAD]: [[M.names], []],
    [RA.SUBSCRIBECREATEANDREAD_ACK]: [[M.correlationId], []],
    ...
    [RA.INVALID_PATCH_ON_HOTPATH]: [[M.name, M.originalAction], [M.correlationId]],
    [RA.LISTEN]: [[M.name], []],
    ...
    [RA.LISTEN_RESPONSE_TIMEOUT]: [[M.subscription], []],
  ...
  [TOPIC.RPC]: {
    ...
    [PA.PROVIDE]: [[M.names], []],
    [PA.PROVIDE_ACK]: [[M.correlationId], []],
    [PA.UNPROVIDE]: [[M.names], []],
    [PA.UNPROVIDE_ACK]: [[M.correlationId], []],
  ...
  [TOPIC.EVENT]: {
    [EA.EMIT]: [[M.name], []],
    [EA.SUBSCRIBE]: [[M.names], []],
    [EA.SUBSCRIBE_ACK]: [[M.correlationId], []],
    [EA.UNSUBSCRIBE]: [[M.names], []],
    [EA.UNSUBSCRIBE_ACK]: [[M.correlationId], []],
    [EA.MULTIPLE_SUBSCRIPTIONS]: [[M.name], []],
    [EA.NOT_SUBSCRIBED]: [[M.name], []],
    ...
    [EA.LISTEN_RESPONSE_TIMEOUT]: [[M.subscription], []],
    [EA.MESSAGE_PERMISSION_ERROR]: [[M.originalAction, M.name], []],
    [EA.MESSAGE_DENIED]: [[M.originalAction, M.name], []],
    [EA.INVALID_MESSAGE_DATA]: [[M.name, M.originalAction], []],
  },
  [TOPIC.PRESENCE]: {
    [UA.SUBSCRIBE]: [[M.names, M.correlationId], []],
    [UA.SUBSCRIBE_ACK]: [[M.correlationId], []],
    [UA.SUBSCRIBE_ALL]: [[], []],
    [UA.SUBSCRIBE_ALL_ACK]: [[], []],
    [UA.UNSUBSCRIBE]: [[M.names, M.correlationId], []],
    ...
    [UA.MULTIPLE_SUBSCRIPTIONS]: [[], [M.correlationId, M.name, M.originalAction]],
