...
const metaParamsMap: { [t: number]: { [a: number]: [Array<M>, Array<M>] } } = {
  ...
  [TOPIC.RECORD]: {
    ...
    [RA.UPDATE_WITH_WRITE_ACK]: [[M.name, M.version], []],
    [RA.PATCH]: [[M.name, M.version, M.path], []],
    [RA.PATCH_WITH_WRITE_ACK]: [[M.name, M.version, M.path], []],
    [RA.ERASE]: [[M.name, M.version, M.path], []],
    [RA.ERASE_WITH_WRITE_ACK]: [[M.name, M.version, M.path], []],
    [RA.CREATEANDUPDATE]: [[M.name, M.version], []],
    [RA.SUBSCRIBECREATEANDUPDATE]: [[M.name, M.version], []],
    [RA.CREATEANDUPDATE_WITH_WRITE_ACK]: [[M.name, M.version], []],
    [RA.CREATEANDPATCH]: [[M.name, M.version, M.path], []],
    [RA.CREATEANDPATCH_WITH_WRITE_ACK]: [[M.name, M.version, M.path], []],
    [RA.DELETE]: [[M.name], []],
    ...
    [RA.WRITE_ACKNOWLEDGEMENT]: [[M.name], []],
    ...
    [RA.RECORD_CREATE_ERROR]: [[M.name], []],
    [RA.RECORD_UPDATE_ERROR]: [[M.name], []],
    [RA.RECORD_DELETE_ERROR]: [[M.name], []],
    [RA.RECORD_READ_ERROR]: [[M.name], []],
    [RA.RECORD_NOT_FOUND]: [[M.name, M.originalAction], []],
    [RA.INVALID_VERSION]: [[M.name, M.originalAction], []],
    [RA.INVALID_PATCH_ON_HOTPATH]: [[M.name], []],
    [RA.CREATE]: [[], []],
    [RA.LISTEN]: [[M.name], []],
    ...
    [RA.MESSAGE_PERMISSION_ERROR]: [[M.originalAction, M.name], []],
    [RA.MESSAGE_DENIED]: [[M.originalAction, M.name], []],
    [RA.INVALID_MESSAGE_DATA]: [[M.originalAction, M.name, M.version], []],
  },
  [TOPIC.RPC]: {
