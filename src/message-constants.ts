...
export enum EVENT_ACTIONS {
    ...
    SUBSCRIPTION_HAS_PROVIDER = 0x10,
    SUBSCRIPTION_HAS_NO_PROVIDER = 0x11,
...
export enum RECORD_ACTIONS {
    ...
    SUBSCRIBEANDHEAD_BULK = 0x70,
    SUBSCRIBEANDHEAD_BULK_ACK = 0xF0,

    SUBSCRIBEANDREAD = 0x22,
    // SUBSCRIBEANDREAD_RESPONSE = 0x23,
    SUBSCRIBEANDREAD_BULK = 0x23,
    SUBSCRIBEANDREAD_BULK_ACK = 0xA3,
    ...
    SUBSCRIBECREATEANDUPDATE_BULK = 0x26,
