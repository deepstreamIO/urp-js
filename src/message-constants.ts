export type ALL_ACTIONS = RECORD_ACTIONS | PRESENCE_ACTIONS | RPC_ACTIONS |
  ...
  CLUSTER_ACTIONS | STATE_REGISTRY_ACTIONS
...
export enum CLUSTER_ACTIONS {
    ...
    PING = 0x01,
    PONG = 0x02,
    IDENTIFICATION_REQUEST = 0x03,
    IDENTIFICATION_RESPONSE = 0x04,
    KNOWN_PEERS = 0x05,
    REJECT = 0x06,
    REJECT_DUPLICATE = 0x07,
    CLOSE = 0x08,
    SELF_MSGBUS_CONNECTION = 0x09,
...
export enum STATE_REGISTRY_ACTIONS {
    DISTRIBUTED_STATE_ADD = 0x00,
    DISTRIBUTED_STATE_REMOVE = 0x01,
    DISTRIBUTED_STATE_REQUEST_FULL_STATE = 0x02,
    DISTRIBUTED_STATE_FULL_STATE = 0x03,
    CLUSTER_JOIN = 0x04,
    CLUSTER_LEAVE = 0x05,
}
...
export const ACTIONS = {
    ...
    [TOPIC.STATE_REGISTRY]: STATE_REGISTRY_ACTIONS
}
