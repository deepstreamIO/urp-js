...
export enum RECORD_ACTIONS {
    ...
    SUBSCRIBEANDHEAD_BULK = RECORD_ACTIONS.SUBSCRIBEANDHEAD | 0x70,

    SUBSCRIBEANDREAD = 0x22,
    // SUBSCRIBEANDREAD_RESPONSE = 0x23,
    SUBSCRIBEANDREAD_BULK = RECORD_ACTIONS.SUBSCRIBEANDREAD | 0x70,

    SUBSCRIBECREATEANDREAD = 0x24,
    // SUBSCRIBECREATEANDREAD_RESPONSE = 0x25,
    SUBSCRIBECREATEANDREAD_BULK = RECORD_ACTIONS.SUBSCRIBECREATEANDREAD | 0x70,

    SUBSCRIBECREATEANDUPDATE = 0x26,
    // SUBSCRIBECREATEANDUPDATE_RESPONSE = 0x27,
    SUBSCRIBECREATEANDUPDATE_BULK = RECORD_ACTIONS.SUBSCRIBECREATEANDUPDATE | 0x70,

    SUBSCRIBE = 0x28,
    SUBSCRIBE_ACK = 0xA8,
    SUBSCRIBE_BULK = RECORD_ACTIONS.SUBSCRIBE | 0x70,
