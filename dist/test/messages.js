...
exports.CONNECTION_MESSAGES = {
    ...
    CHALLENGE: m({
        ...
        urp: {
            value: binMsg(message_constants_1.TOPIC.CONNECTION, message_constants_1.CONNECTION_ACTIONS.CHALLENGE, { u: 'ws://url.io', x: '0.1a' }, ''),
            args: ['url', 'version'],
            payload: null,
...
exports.RECORD_MESSAGES = {
    ...
    INVALID_PATCH_ON_HOTPATH: m({
        message: {
            ...
            name: 'recordName',
            originalAction: message_constants_1.RECORD_ACTIONS.PATCH
        },
        urp: {
            value: binMsg(message_constants_1.TOPIC.RECORD, message_constants_1.RECORD_ACTIONS.INVALID_PATCH_ON_HOTPATH, { n: 'recordName', a: message_constants_1.RECORD_ACTIONS.PATCH }, ''),
            args: ['name'],
            payload: null,
        }
    }),
...
exports.RPC_MESSAGES = {
    ...
    INVALID_RPC_CORRELATION_ID: m({
        message: {
            ...
            originalAction: message_constants_1.RPC_ACTIONS.RESPONSE,
            name: 'addValues',
            correlationId: '/=/=/=/',
        },
        urp: {
            value: binMsg(message_constants_1.TOPIC.RPC, message_constants_1.RPC_ACTIONS.INVALID_RPC_CORRELATION_ID, { n: 'addValues', c: '/=/=/=/', a: message_constants_1.RPC_ACTIONS.RESPONSE }, ''),
            args: ['name', 'correlationId'],
            payload: null
        }
    }),
